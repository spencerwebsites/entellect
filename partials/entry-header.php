<?php if ( is_singular() ) { ?>
    ...
    <header class="-mx-wrap px-wrap py-20 min-h-screen-50 <?php echo $classes; ?> flex items-center justify-center bg-center bg-cover relative" style="background-image: url('<?php if ( has_post_thumbnail() ) echo the_post_thumbnail_url(); ?>'); background-blend-mode: multiply;">
